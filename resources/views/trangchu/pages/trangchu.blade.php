         ...
         <div class="col fill_height">
            ...
            <div class="search_tabs_container">
               <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                  <div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><a style="color:#2d2c2c" href="{{ route('trangchu.pages.dichvu') }}"><img src="travel/images/suitcase.png" alt="">KHÁCH SẠN</a></div>
                  <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><a style="color:#2d2c2c" href="{{ route('trangchu.pages.dichvu') }}"><img src="travel/images/bus.png" alt="">XE DU LỊCH</a></div>
                  <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><a style="color:#2d2c2c" href="{{ route('trangchu.pages.dichvu') }}"><img src="travel/images/departure.png" alt="">MÁY BAY</a></div>
                  {{--
                  ...
                  --}}
                  <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"> <a style="color:#2d2c2c" href="{{ route('trangchu.pages.dichvu') }}"><img src="travel/images/cruise.png" alt="">TÀU CAO TỐC</a></div>
                  {{--
