...
<div class="intro">
   <div class="container">
      <div class="row">
         <div class="col-lg-7">
            <div class="intro_image"><img src="travel/images/intro.png" alt=""></div>
         </div>
         <div class="col-lg-5">
         ...
         <div class="col">
            <div class="stats_contents">
               ...
               <div class="stats_item d-flex flex-md-row flex-column clearfix">
                  ...
                  <div class="stats_bar order-md-2 order-2" data-x="642" data-y="3527" data-color="#31124b">
               ...
               <div class="stats_item d-flex flex-md-row flex-column clearfix">
                  <div class="stats_last order-md-1 order-3">
                     ...
                     <div class="stats_last_content">
                        ...
                        <div class="stats_type">Tất Cả Dịch Vụ</div>
                     </div>
                  </div>
                  <div class="stats_bar order-md-2 order-2" data-x="1546" data-y="9321" data-color="#fa6f1b">
                     <div class="stats_bar_perc">
                        <div>
                           <div class="stats_bar_value"></div>
                        </div>
               ...
               <div class="stats_item d-flex flex-md-row flex-column clearfix">
                  <div class="stats_last order-md-1 order-3">
                     ...
                     <div class="stats_last_content">
                        ...
                        <div class="stats_type">Thời Gian Phục Vụ</div>
                     </div>
                  </div>
      ...
      <div class="row">
         ...
         <div class="col-lg-3 milestone_col">
            <div class="milestone text-center">
               <div class="milestone_icon"><img src="travel/images/milestone_1.png" alt=""></div>
               <div class="milestone_counter" data-end-value="999">0</div>
         ...
         <div class="col-lg-3 milestone_col">
            <div class="milestone text-center">
               <div class="milestone_icon"><img src="travel/images/milestone_2.png" alt=""></div>
               <div class="milestone_counter" data-end-value="50">0</div>
               <div class="milestone_text">Đặc Sản</div>
            </div>
         </div>
         <!-- Milestone -->
         <div class="col-lg-3 milestone_col">
            <div class="milestone text-center">
               <div class="milestone_icon"><img src="travel/images/milestone_3.png" alt=""></div>
               <div class="milestone_counter" data-end-value="15">0</div>
               <div class="milestone_text">Địa Điểm</div>
            </div>
         </div>
         <!-- Milestone -->
         <div class="col-lg-3 milestone_col">
            <div class="milestone text-center">
               <div class="milestone_icon"><img src="travel/images/milestone_4.png" alt=""></div>
               <div class="milestone_counter" data-end-value="20">0</div>
               <div class="milestone_text">Tour</div>
            </div>
         </div>
      </div>
   </div>
