         ...
         <div class="col fill_height">
            ...
            <div class="search_tabs_container">
               <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                  <div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="travel/images/suitcase.png" alt=""><span>KHÁCH SẠN</span></div>
                  <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="travel/images/bus.png" alt="">XE DU LỊCH</div>
                  <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="travel/images/departure.png" alt="">MÁY BAY</div>
                  {{--
                  ...
                  --}}
                  <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="travel/images/cruise.png" alt="">TÀU CAO TỐC</div>
                  {{--
                        ...
                        <div class="test_content_container">
                           <div class="test_content">
                              <div class="test_item_info">
                                 <div class="test_name"><a style="color:black;" href="{{ route('trangchu.chitiet.car',['slug'=>str_slug($item->todo),'id'=>$item->id]) }}">chi tiết</a></div>
                              </div>
...
<meta name="og:url" content="{{ route('trangchu.pages.dichvu') }}" />
@endsection
