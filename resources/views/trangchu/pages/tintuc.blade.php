      ...
      <div class="row">
         ...
         <div class="col-lg-8">
            <div class="blog_post_container">
               <!-- Blog Post --><h1 style="font-family: Times, serif;color:black; font-size: 200%;font-weight:700;text-align:center">Tin Tức Du Lịch</h1><br>
               @foreach ($tin as $item)
               <div class="blog_post">
                  <div class="blog_post_image">
                     <h2><a href="{{ route('trangchu.chitiet.news',['slug'=>str_slug($item->tieuDe),'id'=>$item->id]) }}"><img class="custom-img" src="/{{ str_replace('\\','/',$item->img) }}" alt="du lịch lý sơn"></a></h2>
                  ...
                  <div class="blog_post_link"><h3><a href="{{ route('trangchu.chitiet.news',['slug'=>str_slug($item->tieuDe),'id'=>$item->id]) }}">Xem Thêm</a></h3></div>
               </div>
               @endforeach
            </div>
