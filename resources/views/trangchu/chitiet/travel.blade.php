            ...
            <div class="col-lg-8">
                <div class="blog_post_container">
                    ...
                    <div class="blog_post">
                        ...
                        <br>
                        <div class="fb-like" data-href="{{ route('trangchu.chitiet.travel',['slug'=>str_slug($chitiet->tenTour),'id'=>$chitiet->id]) }}" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
...
<meta name="og:url" content="{{ route('trangchu.chitiet.travel',['slug'=>str_slug($chitiet->tenTour),'id'=>$chitiet->id]) }}" /> @endsection
