      ...
      <div class="row">
         ...
         <div class="col-lg-8">
            <div class="blog_post_container">
               <!-- Blog Post -->
               <div class="blog_post">
                  <h3 style="text-align:left;font-weight: 700;color:black">Tên Tour : {{ $chitiet->tenTour }}</h3>
                  <br>
                  <div class="fb-like" data-href="{{ route('trangchu.chitiet.travel',['slug'=>str_slug($chitiet->tenTour),'id'=>$chitiet->id]) }}" data-layout="standard"
                     data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                  <div class="blog_post_text">
                     {!! $chitiet->noiDung !!}
                  </div>
                  <br>
                  <div class="fb-comments" data-href="{{ route('trangchu.chitiet.travel',['slug'=>str_slug($chitiet->tenTour),'id'=>$chitiet->id]) }}"  data-numposts="5"></div>
               </div>
            </div>
         </div>
         <!-- Blog Sidebar -->
         <div class="col-lg-4 sidebar_col">
            ...
            <div class="sidebar_latest_posts">
               <div class="sidebar_title">TOUR HOT</div>
...
<meta name="og:url" content="{{ route('trangchu.chitiet.travel',['slug'=>str_slug($chitiet->tenTour),'id'=>$chitiet->id]) }}"/>
@endsection
