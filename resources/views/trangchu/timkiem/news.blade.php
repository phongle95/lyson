               ...
               <div class="blog_post_container">
                  ...
                  <div class="blog_post">
                     <div class="blog_post_image">
                        <img class="custom-img" src="/{{ $item->img }}" alt="du lịch lý sơn">
            ...
            <div class="sidebar_categories">
               ...
               <div class="sidebar_list">
                  <ul>
                     ...
                     <li><a href="{{ route('trangchu.pages.loaitin',['slug'=>str_slug($item->tenLoaiTin),'id'=>$item->maLoaiTin]) }}">{{ $item->tenLoaiTin }}</a></li>
                     @endforeach
                  </ul>
               </div>
            </div>
                  ...
                  <ul>
                     ...
                     <li class="latest_post clearfix">
                        <div class="latest_post_image">
                           <a href="{{ route('trangchu.chitiet.news',['slug'=>str_slug($item->tieuDe),'id'=>$item->id]) }}"><img class="smal-img" src="/{{ $item->img }}" alt=""></a>
                        </div>
...
<meta name="og:url" content="{{ route('trangchu.timkiem.news') }}" />
@endsection
